...
function renderStoriesOfTheDay(posts) {
  ...
  return `<section class="daily-stories" aria-labelledby="daily-stories-title" data-daily-stories><div class="section-heading"><h2 id="daily-stories-title">Verhalen van de dag</h2><p>Kies elke dag uit vier herkenbare ervaringen en blader rustig door wat anderen voelden.</p></div><div class="daily-story-frame"><div class="daily-story-carousel"><button type="button" class="daily-story-nav" data-daily-prev aria-label="Vorig verhaal">←</button><div class="daily-story-track" aria-live="polite">${slides}</div><button type="button" class="daily-story-nav" data-daily-next aria-label="Volgend verhaal">→</button></div><div class="daily-story-dots" aria-label="Verhalen van de dag navigatie">${dots}</div></div></section>`;
}
