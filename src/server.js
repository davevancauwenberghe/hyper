...
<body>
  ...
  <footer class="site-footer"><p>Hyperpedia is op geen enkele manier medisch bewezen of medisch gevalideerd. Controleer nieuwe of aanhoudende klachten altijd bij je zorgverlener om zeker te weten wat er speelt. <button class="footer-info-link" type="button" data-info-open>Meer info</button></p></footer>
